...
export default function FormPage() {
  ...
  const Title = React.useCallback(
    (
      props: React.PropsWithChildren<{}> // eslint-disable-line @typescript-eslint/no-empty-object-type
    ) => (
      <m.h1
  ...
  return (
    <div className="flex h-full w-full items-center justify-center min-h-screen bg-background p-4">
